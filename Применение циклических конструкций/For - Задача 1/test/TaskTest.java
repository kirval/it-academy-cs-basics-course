...
public class TaskTest {
    ...
    @Test
    public void test1() {
        final ByteArrayInputStream in = new ByteArrayInputStream("0 10".getBytes());
        System.setIn(in);
    ...
    @Test
    public void test2() {
        final ByteArrayInputStream in = new ByteArrayInputStream("10 0".getBytes());
        System.setIn(in);
    ...
    @Test
    public void test3() {
        final ByteArrayInputStream in = new ByteArrayInputStream("10 1".getBytes());
        System.setIn(in);
